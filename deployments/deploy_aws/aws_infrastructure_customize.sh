...
echo "AWS Mashines Size (t3.medium/t3.large/t3.xlarge/t3.2xlarge/t2.medium/t2.large/t2.xlarge/t2.2xlarge):"
...
if [[ $AWS_MASHINES_SIZE = "t3.medium" ]] || [[ $AWS_MASHINES_SIZE = "t3.large" ]] || [[ $AWS_MASHINES_SIZE = "t3.xlarge" ]] || [[ $AWS_MASHINES_SIZE = "t3.2xlarge" ]] || [[ $AWS_MASHINES_SIZE = "t2.medium" ]] || [[ $AWS_MASHINES_SIZE = "t2.large" ]] || [[ $AWS_MASHINES_SIZE = "t2.xlarge" ]] || [[ $AWS_MASHINES_SIZE = "t2.2xlarge" ]]
then
